...
public class Client extends Thread {
    ...
    int bufferSize = 1024 * 1024 * 10;// 设置缓冲区大小为10M
    ...
    String[] readDirectory(String dirname, int bufferSize) {
        ...
        int M_num = 1000;// 假设任务队列最多可容纳100个任务
...
//        // 要上传的文件路径，服务器地址、端口号
//        String uploadUrl =
//                "D:\\study file\\Third\\operate system\\proj_school\\upload\\";
...
//            // String fileQue[] = readDirectory(uploadUrl);
